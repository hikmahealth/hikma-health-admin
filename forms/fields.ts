...
export function createMedicineField(opts?: {
  ...
  return {
    ...
    fields: {
      name: createTextField({ name: 'Name', description: 'Name of the medicine' }),
      ...
      dose: createTextField({ name: 'Dose', description: 'Dose of the medicine' }),
      ...
      frequency: createTextField({ name: 'Frequency', description: 'Frequency of the medicine' }),
      intervals: createTextField({ name: 'Intervals', description: 'Intervals of the medicine' }),
      duration: createTextField({ name: 'Duration', description: 'Duration of the medicine' }),
...
export const createDateField = (opts?: Partial<{ name: string; description: string }>) => {
  return {
    id: nanoid(),
    name: opts?.name ?? 'Date',
    description: opts?.description ?? '',
